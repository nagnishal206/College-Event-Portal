...
class User(UserMixin, db.Model):
    ...
    profile_photo = Column(String(255), nullable=True, default="default.png")
...
class Event(db.Model):
    ...
    poster = Column(String(255), nullable=True, default="default_poster.jpg")
